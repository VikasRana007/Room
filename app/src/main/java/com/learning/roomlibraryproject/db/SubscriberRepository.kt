 ...
 * web services and caches without repository mediator we can also make communication between Model and View Model but
...
class SubscriberRepository(private val subscriberDAO: SubscriberDAO) {
     ...
     */
        ...
        val subscribers = subscriberDAO.getAllSubscriber()    // No need to call from back ground thread Room library do it by itself
